        ...
        <nav className="fixed top-0 left-0 right-0 z-50 bg-[#F5F2ED]/95 backdrop-blur-md border-b border-[#8A9A7B]/20">
            <div className="max-w-7xl mx-auto px-6 py-4">
                <div className="flex items-center justify-between">
                    <img src="https://i.gyazo.com/61a1663e5719570462b02fe73ee1c268.png" alt="ARTEL"
                         className="h-10 w-auto"/>

                    {/* Desktop Navigation */}
                    <div className="hidden md:flex items-center gap-8">
                        <button onClick={() => scrollToSection('gallery')}
                                className="text-[#6B7562] hover:text-[#3D4436] transition-colors cursor-pointer">
                            Portfolio
                        </button>
                ...
                {isMenuOpen && (
                    <div className="md:hidden pt-4 pb-2 flex flex-col gap-4">
                        <button onClick={() => scrollToSection('gallery')}
                                className="text-[#6B7562] hover:text-[#3D4436] transition-colors text-left">
                            Portfolio
                        </button>
                        <button onClick={() => scrollToSection('services')}
                                className="text-[#6B7562] hover:text-[#3D4436] transition-colors text-left">
